...
#give ARG APP_ENV a default value = local
# ARG APP_ENV=local

#assign the $APP_ENV arg to the APP_ENV ENV so that it can be accessed
#by the subsequent RUN call within the container
ENV APP_ENV $APP_ENV

#the subsequent RUN call accesses the APP_ENV ENV variable within the container
