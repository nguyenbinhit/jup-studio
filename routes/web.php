...
use App\Http\Controllers\Admins\Pages\ServiceController;
...
Route::prefix('admins')->name('admin.')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::prefix('service-pages')->name('pages.')->group(function () {
            Route::get('/{page:slug}', [ServiceController::class, 'show'])->name('service.show');
            Route::put('/{page:slug}', [ServiceController::class, 'update'])->name('service.update');
        });
