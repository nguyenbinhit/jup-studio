            ...
            <div id="rev_slider_8_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.8.1">
                <ul>
                    ...
                    <li data-index="rs-36" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                        ...
                        <div class="tp-caption tp-resizeme" data-x="['center','center','center','center']"
                            ...
                            <div class="rs-looped rs-slideloop" data-easing="Power0.easeInOut" data-speed="12"
                                data-xs="0" data-xe="60" data-ys="100" data-ye="60"><img
                                    src="{{ asset('../bootstrapv1/img/slider-shape1.png') }}" alt
                        ...
                        <div class="tp-caption tp-resizeme" data-x="['right','right','right','right']"
                            ...
                            <div class="rs-looped rs-slideloop" data-easing="Power0.easeInOut" data-speed="12"
                                data-xs="0" data-xe="-50" data-ys="50" data-ye="20"><img
                                    src="{{ asset('../bootstrapv1/img/slider-shape2.png') }}" alt
                        ...
                        <div class="tp-caption tp-resizeme" data-x="['left','left','left','left']"
                            ...
                            <div class="rs-looped rs-rotate" data-easing="Power0.easeIn" data-startdeg="0"
                                data-enddeg="360" data-speed="15" data-origin="50% 50%"><img
                                    src="{{ asset('../bootstrapv1/img/slider-shape3.png') }}" alt
                        ...
                        <div class="tp-caption tp-resizeme" data-x="['right','right','right','right']"
                            data-hoffset="['-200','-200','-5000','-5000']" data-y="['bottom','bottom','bottom','bottom']"
                            ...
                            <div class="rs-looped rs-slideloop" data-easing="Power0.easeInOut" data-speed="12"
                                data-xs="0" data-xe="0" data-ys="10" data-ye="-50"><img
                                    src="{{ asset('../bootstrapv1/img/slider-shape4.png') }}" alt
                        ...
                        <div class="tp-caption tp-resizeme" data-x="['left','left','left','left']"
                            ...
                            <div class="rs-looped rs-slideloop" data-easing="Power0.easeInOut" data-speed="12"
                                data-ys="-40" data-ye="40" data-xs="0" data-xe="20"><img
                                    src="{{ asset('../bootstrapv1/img/slider-shape5.png') }}" alt
                        ...
                        <div class="tp-caption tp-resizeme" data-x="['right','right','right','right']"
                            ...
                            <div class="rs-looped rs-wave" data-speed="12" data-angle="90" data-radius="12px"
                                data-origin="0% 0%"><img src="{{ asset('../bootstrapv1/img/slider-shape6.png') }}" alt
                                    data-ww="['44px','44px','44px','44px']" data-hh="['87px','87px','87px','87px']"
                                    data-no-retina> </div>
                        </div>
                        ...
                        <div class="tp-caption" data-x="['left','left','left','left']"
                            ...
                            <div class="rs-looped rs-rotate" data-easing="Power0.easeIn" data-speed="150"
                                data-startdeg="0" data-enddeg="360" data-origin="45% 45%"><img
                                    src="{{ asset('../bootstrapv1/img/circle-top-left.png') }}" alt
                        ...
                        <div class="tp-caption" data-x="['left','left','left','left']"
                            ...
                            <div class="rs-looped rs-wave" data-speed="6" data-angle="0" data-radius="5px"
                                data-origin="50% 50%"><img
                                    src="{{ asset('../bootstrapv1/img/circle-top-right-inner.png') }}" alt
                        ...
                        <div class="tp-caption" data-x="['left','left','left','left']"
                            ...
                            <div class="rs-looped" data-easing="Power0.easeInOut" data-speed="0" data-xs="0"
                                data-xe="0" data-ys="0" data-ye="0"><img
                                    src="{{ asset('../bootstrapv1/img/circle-top-right.png') }}" alt
                                    data-ww="['381px','381px','381px','381px']"
                                    data-hh="['380px','380px','380px','380px']" data-no-retina> </div>
                        </div>

                        <!-- LAYER Center -->
                        <div class="tp-caption tp-resizeme rs-parallaxlevel-8" data-x="['left','left','center','center']"
                            data-hoffset="['300','300','-5000','-5000']" data-y="['top','top','middle,'middle']"
                            data-voffset="['50','50','0','0']" data-type="image" data-responsive_offset="on"
                            data-frames='[{"delay":319.921875,"speed":500,"frame":"0","from":"z:0;rX:0;rY:0;rZ:0;sX:0.9;sY:0.9;skX:0;skY:0;opacity:0;","to":"o:1;","ease":"Power2.easeOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                            style="z-index: 1;">
                            <div class="rs-looped rs-wave" data-speed="15" data-angle="90" data-radius="12px"
                                data-origin="50% 50%"><img src="{{ asset('../bootstrapv1/img/circle-center.png') }}" alt
                        ...
                        <div class="tp-caption tp-resizeme" data-x="['left','left','left','left']"
                            ...
                            <div class="rs-looped rs-slideloop" data-easing="Power0.easeInOut" data-speed="30"
                                data-xs="-90" data-xe="90" data-ys="0" data-ye="20"><img
                                    src="{{ asset('../bootstrapv1/img/arrows.png') }}" alt
                                    data-ww="['97px','97px','97px','97px']" data-hh="['98px','98px','98px','98px']"
                                    data-no-retina> </div>
                        </div>
